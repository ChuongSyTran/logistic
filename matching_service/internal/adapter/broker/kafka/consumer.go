...
func (cgh *consumerGroupHandler) ConsumeClaim(session sarama.ConsumerGroupSession, claim sarama.ConsumerGroupClaim) error {
	for {
		...
		case msg, ok := <-claim.Messages():
			...
			err := cgh.appHandler(session.Context(), msg.Topic, msg.Value)
			if err != nil {
...
func (c *kafkaConsumer) Consume(ctx context.Context, topic string, handler app.EventHandler) error {
