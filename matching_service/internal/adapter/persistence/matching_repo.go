...
var _ app.MatchingRepo = (*matchingRepoImpl)(nil)

func NewMatchingRepo(masterClient *ent.Client, slaveClient *ent.Client, mapper *generated.MatchingMapperImpl) app.MatchingRepo {
